...
shinyUI(dashboardPage(
    dashboardHeader(title = "Primary Education Trends"),
    dashboardSidebar(
    ...
    dashboardBody(
        ...
        tabItems(
            tabItem(tabName = "region",
                    ...
                    fluidRow(box(title = 'Individual Country View', htmlOutput("region"), height = 300, width = '100%'))),
            ...
            tabItem(tabName = 'graph',
                    ...
                    fluidRow(box(title = 'Indicator View by Region', plotlyOutput('graph'), height = 800, width = "100%"))
                                                                                          )),
