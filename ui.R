...
shinyUI(dashboardPage(
    ...
    dashboardSidebar(
        ...
        sidebarMenu(
            ...
            menuItem('Additional Info', tabName = 'info', icon = icon('bookmark')),
                    ...
                    fluidRow(box(title = 'Selections',
                                 ...
                                 selectizeInput("selected",
                                                ...
                                                c('Cumulative drop-out rate (both sexes %)' = 'Cum_drop_both',
                                                  ...
                                                  'Govt expenditure on ed (% of GDP)' = 'Govt_exp_GDP',
                                                  'Govt expenditure on primary ed (% of GDP)' = 'Govt_exp_prim_ed_GDP',
